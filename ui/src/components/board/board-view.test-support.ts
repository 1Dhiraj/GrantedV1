...
type GrantedBoardWidgetCell = HTMLElementTagNameMap["openclaw-board-widget-cell"];
...
export async function settleCells(view: GrantedBoardView): Promise<GrantedBoardWidgetCell[]> {
