...
export abstract class GrantedLitElement extends LitElement {
...
export abstract class GrantedLightDomElement extends GrantedLitElement {
...
export abstract class GrantedLightDomContentsElement extends GrantedLightDomElement {
