import type { EventFrame, HelloOk } from "@granted/gateway-protocol";
import {
  isGatewayEventFrame,
  isGatewayResponseFrame,
} from "@granted/gateway-protocol/frame-guards";
import { RetrySupervisor, sleepWithAbort } from "@granted/retry";
