...
const CLAWHUB_REPO_ENV = "GRANTED_DOCS_SYNC_CLAWHUB_REPO";
...
export function parseArgs(argv) {
  const args = {
    ...
    clawhubSourceRepo:
      process.env.GRANTED_DOCS_SYNC_CLAWHUB_SOURCE_REPO || DEFAULT_CLAWHUB_SOURCE_REPO,
    clawhubSourceSha: process.env.GRANTED_DOCS_SYNC_CLAWHUB_SOURCE_SHA || "",
  };
