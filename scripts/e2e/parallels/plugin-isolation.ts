...
export function posixCodexPlatformPackageRepairFunction(): string {
  ...
  codex_manifest=""
  for candidate in "$state_home"/.openclaw/npm/projects/*/node_modules/@granted/codex/package.json; do
  ...
  project_root="\${codex_manifest%/node_modules/@granted/codex/package.json}"
