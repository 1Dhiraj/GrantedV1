...
const LOCALIZED_WRAPPER_CONTRACTS: Record<string, readonly string[]> = {
  ...
  "apps/ios/Sources/Design/OpenClawProComponents.swift": [
    "enum GrantedTextValue: ExpressibleByStringLiteral",
    "struct ProSectionHeader: View {\n    let title: GrantedTextValue",
    "struct GrantedNoticeBanner: View {\n    let icon: String\n    let title: GrantedTextValue\n    let message: GrantedTextValue",
    "struct GrantedAdaptiveHeaderRow<Leading: View, Accessory: View>: View {\n    let title: GrantedTextValue\n    let subtitle: GrantedTextValue?",
    "struct GrantedStatusBadge: View {\n    @Environment(\\.colorScheme) private var colorScheme\n    let label: GrantedTextValue",
  ...
  "apps/ios/Sources/Design/SettingsProTabSupport.swift": [
    ...
    "init(_ label: LocalizedStringKey, value: GrantedTextValue)",
    "self.value.text",
  ...
  "apps/ios/Sources/Design/SettingsProTabActions.swift": [
    ...
    "pendingApproval.commandPreview.map(GrantedTextValue.verbatim)",
  ...
  "apps/ios/Sources/Design/AgentProNodesDestination.swift": [
    "private func nodeDetailRow(\n        _ title: GrantedTextValue,\n        copyLabel: LocalizedStringKey",
    "private func nodeListCard(title: GrantedTextValue, values: [String])",
  ],
