  ...
  try {
    ...
    await runInstalledCli({
      ...
      env: {
        ...
        GRANTED_UPDATE_DEV_TARGET_REF: verificationRef,
      },
      cwd: lane.homeDir,
...
function buildLaneEnv(
  ...
  return {
    ...
    GRANTED_HOME: lane.homeDir,
    GRANTED_STATE_DIR: lane.stateDir,
    GRANTED_CONFIG_PATH: join(lane.stateDir, "openclaw.json"),
