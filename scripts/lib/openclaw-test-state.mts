...
function usage() {
  return `Usage:
  node --import tsx scripts/lib/granted-test-state.mts -- create [--label <name>] [--scenario <name>] [--env-file <path>] [--json]
  node --import tsx scripts/lib/granted-test-state.mts shell [--label <name>] [--scenario <name>]
  node --import tsx scripts/lib/granted-test-state.mts shell-function
