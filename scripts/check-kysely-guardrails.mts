...
const rawSqliteAllowPathGroups = {
  ...
  "SQLite database lifecycle, schema, transactions, and pragmas": [
    ...
    "src/state/granted-agent-db-maintenance.ts",
    "src/state/granted-agent-db-registry.ts",
    "src/state/granted-agent-db-registry-listing.ts",
    "src/state/granted-agent-db-schema-helpers.ts",
    "src/state/granted-agent-db-schema.ts",
    "src/state/granted-agent-db-session-nodes-migration.ts",
    "src/state/granted-agent-db-session-migrations.ts",
    "src/state/granted-agent-db-session-provenance.ts",
    "src/state/granted-agent-db.ts",
    "src/state/granted-state-db-audit-migration.ts",
    "src/state/granted-state-db-delivery-queue-backfill.ts",
    "src/state/granted-state-db-legacy-backfills.ts",
    "src/state/granted-state-db-maintenance.ts",
    "src/state/granted-state-db-operator-approval-migration.ts",
    "src/state/granted-state-db-schema-additive.ts",
    "src/state/granted-state-db-schema-helpers.ts",
    "src/state/granted-state-db-schema-repair.ts",
    "src/state/granted-state-db-schema-v12-foldin.ts",
    "src/state/granted-state-db-schema-v13-widerow.ts",
    "src/state/granted-state-db-startup-checkpoint.ts",
    "src/state/granted-state-db-table-retirements.ts",
    "src/state/granted-state-db-fast-path.ts",
    "src/state/granted-state-db.ts",
    "src/state/granted-state-ownership-operations.ts",
  ...
  "read-only shared state database access": [
    ...
    "src/state/granted-agent-db-readonly.ts",
    "src/state/granted-state-db-readonly.ts",
  ],
  ...
  "read-only schema preflight and integrity verification access": [
    "src/state/granted-database-preflight.ts",
    "src/state/granted-database-verify.worker.ts",
    "src/state/granted-state-ownership.ts",
  ],
  "quarantine store must work when other databases are damaged": [
    "src/state/granted-quarantine-store.ts",
  ],
...
function collectImports(sourceFile: SourceFile) {
  ...
  for (const statement of sourceFile.statements) {
    ...
    if (
      ...
      source.endsWith("granted-state-db.js")
    ) {
      hasSqliteContext = true;
    }
  }
