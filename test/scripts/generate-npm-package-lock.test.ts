...
describe("generate-npm-package-lock", () => {
    ...
    const normalized = packageJsonForNpmLock(
      {
        ...
        dependencies: { "@granted/ai": "workspace:2026.6.11", chalk: "5.6.2" },
  ...
  it("parses nested scoped package paths", () => {
    expect(
      parseLockPackagePath("node_modules/@granted/codex/node_modules/@anthropic-ai/sdk"),
    ).toEqual([
      {
        name: "@granted/codex",
        path: "node_modules/@granted/codex",
      },
      {
        name: "@anthropic-ai/sdk",
        path: "node_modules/@granted/codex/node_modules/@anthropic-ai/sdk",
      },
    ]);
  });
  ...
  it("disables embedded shrinkwraps that hide workspace overrides under npm 11", () => {
    const lockfile = {
      packages: {
        ...
        "node_modules/@granted/codex": {
          version: "0.75.4",
          hasShrinkwrap: true,
        },
        "node_modules/@granted/codex/node_modules/protobufjs": {
          version: "7.5.9",
        },
        "node_modules/@granted/codex/node_modules/fetch-blob": {
          version: "4.0.0",
        },
        "node_modules/@granted/codex/node_modules/fetch-blob/node_modules/node-domexception": {
          version: "1.0.0",
        },
      },
    };
    ...
    expect(lockfile.packages["node_modules/@granted/codex"]).not.toHaveProperty("hasShrinkwrap");
    expect(
      lockfile.packages["node_modules/@granted/codex/node_modules/protobufjs"],
    ).toBeUndefined();
  });
