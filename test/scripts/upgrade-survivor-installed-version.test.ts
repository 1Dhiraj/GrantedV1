...
`,
      ...
      const result = spawnSync("bash", [runner], {
        ...
        env: {
          ...
          TMPDIR: tmp,
          GRANTED_UPGRADE_SURVIVOR_RUNTIME_ROOT: join(home, "runtime"),
          GRANTED_UPGRADE_SURVIVOR_SUMMARY_JSON: summaryPath,
          GRANTED_UPGRADE_SURVIVOR_BASELINE: `openclaw@${baselineVersion}`,
          GRANTED_UPGRADE_SURVIVOR_CANDIDATE_SPEC: join(home, "candidate.tgz"),
          BASH_ENV: prelude,
        },
      });
