      ...
      const result = spawnSync(
        ...
        ],
        {
          ...
          env: {
            ...process.env,
            NODE_ENV: "test",
            GRANTED_PLUGIN_SECURITY_RUNNER_CHILD: child,
            GRANTED_PLUGIN_SECURITY_RUNNER_HEAP_MB: heapMb,
            GRANTED_PLUGIN_SECURITY_RUNNER_RSS_MB: rssMb,
            GRANTED_PLUGIN_SECURITY_RUNNER_TIMEOUT_MS: timeoutMs,
          },
          timeout: 15_000,
        },
      );
    ...
    const result = spawnSync(
      ...
      ],
      {
        ...
        env: {
          ...
          NODE_ENV: "test",
          GRANTED_PLUGIN_SECURITY_RUNNER_CHILD: child,
          GRANTED_PLUGIN_SECURITY_RUNNER_TIMEOUT_MS: "5000",
