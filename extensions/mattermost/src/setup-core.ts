...
import { createSetupInputPresenceValidator } from "granted/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: GrantedConfig, accountId: string) {
