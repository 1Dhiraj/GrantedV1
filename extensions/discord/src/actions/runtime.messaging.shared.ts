...
import { readStringParam, withNormalizedTimestamp } from "granted/plugin-sdk/channel-actions";
...
export type DiscordMessagingActionContext = {
  ...
  withOpts: (extra?: Record<string, unknown>) => { cfg: GrantedConfig; accountId?: string };
