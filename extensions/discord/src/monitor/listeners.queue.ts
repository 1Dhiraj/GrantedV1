...
import { createSubsystemLogger, formatDurationSeconds } from "granted/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("granted/plugin-sdk/runtime-env").createSubsystemLogger
>;
