...
import type { DiscordAccountConfig } from "granted/plugin-sdk/config-contracts";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("granted/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class GrantedGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new GrantedGatewayPlugin();
}
