...
function createConfig(params?: { requireMention?: boolean }): GrantedConfig {
  return {
    commands: {
...
async function createStatusCommand(cfg: GrantedConfig, pluginExecute?: ReturnType<typeof vi.fn>) {
