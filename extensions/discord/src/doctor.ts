...
export function scanDiscordNumericIdEntries(cfg: GrantedConfig): DiscordNumericIdHit[] {
...
function collectDiscordTranscriptsAutoStartWarnings(cfg: GrantedConfig): string[] {
...
function collectDiscordMutableAllowlistWarnings(cfg: GrantedConfig): string[] {
