...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<GrantedConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<GrantedConfig["channels"]>["discord"]>>,
): GrantedConfig {
  return {
    channels: {
      discord: {
