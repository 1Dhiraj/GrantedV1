...
import { parseStrictFiniteNumber, parseStrictInteger } from "granted/plugin-sdk/number-runtime";
import { isRecord as isPlainObject } from "granted/plugin-sdk/string-coerce-runtime";
