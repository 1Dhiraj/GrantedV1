...
import type { createSlackWebClient } from "@granted/slack/api.js";
...
export const SLACK_QA_APPROVAL_CHECKPOINT_DIR_ENV = "GRANTED_QA_SLACK_APPROVAL_CHECKPOINT_DIR";
export const SLACK_QA_APPROVAL_CHECKPOINT_TIMEOUT_MS_ENV =
  "GRANTED_QA_SLACK_APPROVAL_CHECKPOINT_TIMEOUT_MS";
export const SLACK_QA_WEB_API_TIMEOUT_MS = 45_000;
export const SLACK_QA_ENV_KEYS = [
  "GRANTED_QA_SLACK_CHANNEL_ID",
  "GRANTED_QA_SLACK_DRIVER_BOT_TOKEN",
  "GRANTED_QA_SLACK_SUT_BOT_TOKEN",
  "GRANTED_QA_SLACK_SUT_APP_TOKEN",
] as const;
