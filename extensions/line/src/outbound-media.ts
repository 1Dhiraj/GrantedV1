...
import { getFileExtension, mimeTypeFromFilePath } from "granted/plugin-sdk/media-mime";
import { resolvePinnedHostnameWithPolicy, type SsrFPolicy } from "granted/plugin-sdk/ssrf-runtime";
