...
import { isTruthyEnvValue, isWSL2Sync } from "granted/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "granted/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "GRANTED_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "GRANTED_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "GRANTED_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable GRANTED_TELEGRAM_DNS_RESULT_ORDER
