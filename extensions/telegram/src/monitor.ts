...
import { resolveAgentMaxConcurrent } from "granted/plugin-sdk/model-session-runtime";
...
function createTelegramRunnerOptions(cfg: GrantedConfig): RunOptions<unknown> {
  return {
    sink: {
