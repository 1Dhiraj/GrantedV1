...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<GrantedConfig["channels"]>["telegram"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<GrantedConfig["channels"]>["telegram"]>>,
): GrantedConfig {
  return {
    channels: {
      telegram: {
