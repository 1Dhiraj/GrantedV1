...
import type { PluginCommandNativeCandidate } from "granted/plugin-sdk/plugin-command-runtime";
...
type TelegramNativeReplyPayload = import("granted/plugin-sdk/plugin-entry").PluginCommandResult;
