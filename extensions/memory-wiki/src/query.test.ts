...
vi.mock("@granted/memory-core/api.js", { spy: true });
...
function createAppConfig(): GrantedConfig {
  return {
    agents: {
...
function createSessionVisibilityAppConfig(): GrantedConfig {
  return {
    agents: {
...
function createAgentSessionVisibilityAppConfig(): GrantedConfig {
  return {
