...
import type { AnyAgentTool, GrantedPluginToolFactory } from "granted/plugin-sdk/plugin-entry";
...
function registerMemoryCoreToolFactories(): Map<string, GrantedPluginToolFactory> {
