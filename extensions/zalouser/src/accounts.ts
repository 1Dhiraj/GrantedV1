...
function mergeZalouserAccountConfig(cfg: GrantedConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: GrantedConfig; accountId?: string | null }) {
