...
async function captureOpenRouterWrappedPayload(params: {
  ...
  const baseStreamFn = vi.fn(
    (
      ...args: Parameters<import("granted/plugin-sdk/agent-core").StreamFn>
    ): ReturnType<import("granted/plugin-sdk/agent-core").StreamFn> => {
...
function readManifest(): OpenRouterManifest {
  return JSON.parse(readFileSync(new URL("./granted.plugin.json", import.meta.url), "utf8"));
}
