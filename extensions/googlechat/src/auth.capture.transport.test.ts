...
import { captureHttpExchange, type CaptureEventRecord } from "granted/plugin-sdk/proxy-capture";
import { fetchWithRuntimeDispatcher } from "granted/plugin-sdk/runtime-fetch";
