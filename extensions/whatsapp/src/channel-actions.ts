...
function areWhatsAppAgentReactionsEnabled(params: { cfg: GrantedConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: GrantedConfig) {
