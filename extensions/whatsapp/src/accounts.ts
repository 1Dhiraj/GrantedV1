...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "granted/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: GrantedConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: GrantedConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: GrantedConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: GrantedConfig): ResolvedWhatsAppAccount[] {
