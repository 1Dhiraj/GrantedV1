...
const GRANTED_WHATSAPP_WEB_SOCKET_URL_ENV = "GRANTED_WHATSAPP_WEB_SOCKET_URL";
...
describe("web session", () => {
  ...
  it("uses GRANTED_WHATSAPP_WEB_SOCKET_URL as the default Baileys WebSocket URL", async () => {
    vi.stubEnv(GRANTED_WHATSAPP_WEB_SOCKET_URL_ENV, " ws://127.0.0.1:49153/ws/chat ");
  ...
  it("ignores blank Baileys WebSocket URL environment overrides", async () => {
    vi.stubEnv(GRANTED_WHATSAPP_WEB_SOCKET_URL_ENV, " ");
  ...
  it("rejects invalid GRANTED_WHATSAPP_WEB_SOCKET_URL values", async () => {
    vi.stubEnv(GRANTED_WHATSAPP_WEB_SOCKET_URL_ENV, "http://127.0.0.1:14567/ws");

    await expect(createWaSocket(false, false)).rejects.toThrow(
      "GRANTED_WHATSAPP_WEB_SOCKET_URL must use ws:// or wss://.",
    );
  ...
  it("preserves explicit Baileys WebSocket URL options over invalid environment", async () => {
    vi.stubEnv(GRANTED_WHATSAPP_WEB_SOCKET_URL_ENV, "http://127.0.0.1:49153/ws/chat");
