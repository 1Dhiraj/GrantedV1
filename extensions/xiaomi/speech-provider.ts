...
import { canonicalizeBase64, transcodeAudioBufferToOpus } from "granted/plugin-sdk/media-runtime";
...
import { resolveSpeechProviderApiKey, trimToUndefined } from "granted/plugin-sdk/speech-core";
import {
  fetchWithSsrFGuard,
