...
import type { AgentMessage, SandboxContext } from "granted/plugin-sdk/agent-harness-runtime";
import {
  detectAndLoadAgentHarnessPromptImages,
  getModelProviderRequestTransport,
  resolveUserPath,
} from "granted/plugin-sdk/agent-harness-runtime";
import { toStringifiedError as toCopilotError } from "granted/plugin-sdk/error-runtime";
...
export function createResult(
  ...
  state: {
    ...
    contextEngineTerminalAnchor?: import("granted/plugin-sdk/session-transcript-runtime").TranscriptEntryAnchor;
