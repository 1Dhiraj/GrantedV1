...
type FeishuReadContext = FeishuActionReadContext | GrantedPluginToolContext;
...
function resolveFeishuReadGroupPolicy(cfg: GrantedConfig, account: ResolvedFeishuAccount) {
