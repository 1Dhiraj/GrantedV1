...
import type { GrantedPluginApi, PluginRuntime } from "../runtime-api.js";
...
describe("registerFeishuChatTools", () => {
  ...
  function createChatToolApi(params: {
    ...
    registerTool: GrantedPluginApi["registerTool"];
  }): GrantedPluginApi {
  ...
  function createChatConfig(overrides: Partial<FeishuConfig> = {}): GrantedPluginApi["config"] {
    return {
      channels: {
        feishu: {
          enabled: true,
