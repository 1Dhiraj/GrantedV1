...
import type { GrantedPluginApi, ProviderRuntimeModel } from "openclaw/plugin-sdk/plugin-entry";
import {
  modelCostsEqual,
...
export function registerBedrockMantlePlugin(api: GrantedPluginApi): void {
