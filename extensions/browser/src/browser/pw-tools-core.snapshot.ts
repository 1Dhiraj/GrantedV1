 ...
 * browser tools.
 */
import { parseFiniteNumber, resolveIntegerOption } from "granted/plugin-sdk/number-runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "granted/plugin-sdk/string-coerce-runtime";
import { truncateUtf16Safe, withTimeout } from "granted/plugin-sdk/text-utility-runtime";
