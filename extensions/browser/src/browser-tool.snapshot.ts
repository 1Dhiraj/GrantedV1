...
import { truncateSanitizedExternalContent } from "granted/plugin-sdk/security-runtime";
import { DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS } from "granted/plugin-sdk/text-utility-runtime";
