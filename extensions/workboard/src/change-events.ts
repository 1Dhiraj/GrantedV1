import type { WorkboardChange } from "@granted/workboard-contract";
import type { GrantedPluginService } from "../api.js";
import type { WorkboardStore } from "./store.js";

const WORKBOARD_EXTERNAL_CHANGE_CHECK_MS = 1000;

export function createWorkboardChangeEventService(store: WorkboardStore): GrantedPluginService {
