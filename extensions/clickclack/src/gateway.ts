...
import type { buildChannelInboundEventContext } from "granted/plugin-sdk/channel-inbound";
...
import { readStringField } from "granted/plugin-sdk/string-coerce-runtime";
