...
import type { ManagedProcess, GrantedExecServer, ProcessChunk } from "./types.js";
...
function assertSupportedProcessSandbox(execServer: GrantedExecServer, record: JsonObject): void {
