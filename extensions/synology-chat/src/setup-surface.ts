...
function getChannelConfig(cfg: GrantedConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: GrantedConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: GrantedConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: GrantedConfig, accountId: string): string[] {
