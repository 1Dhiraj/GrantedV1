...
import { listDevicePairing } from "granted/plugin-sdk/device-bootstrap";
...
function openNotifySubscriberStore(api: GrantedPluginApi): NotifySubscriberStore {
...
async function notifyPendingPairingRequests(params: { api: GrantedPluginApi }): Promise<void> {
...
async function runNotifyPoll(api: GrantedPluginApi): Promise<void> {
...
export function createPairingNotifierService(api: GrantedPluginApi): GrantedPluginService {
