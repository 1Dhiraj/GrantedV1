...
import { resolveApprovalOverGateway } from "granted/plugin-sdk/approval-gateway-runtime";
...
import { resolveCommandAuthorization } from "granted/plugin-sdk/command-auth-native";
