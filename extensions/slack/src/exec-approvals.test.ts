...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<GrantedConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<GrantedConfig["channels"]>["slack"]>>,
): GrantedConfig {
  return {
    channels: {
      slack: {
