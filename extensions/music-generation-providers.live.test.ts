...
const providerFilter = parseCsvFilter(process.env.GRANTED_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.GRANTED_LIVE_MUSIC_GENERATION_MODELS);
