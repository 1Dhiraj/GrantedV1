import type { resolveApiKeyForProvider } from "granted/plugin-sdk/provider-auth-runtime";
import type { fetchWithTimeoutGuarded, postJsonRequest } from "granted/plugin-sdk/provider-http";
import {
  asOptionalRecord,
