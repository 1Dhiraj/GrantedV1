...
function openActiveMemoryToggleStore(api: GrantedPluginApi) {
...
function isActiveMemoryGloballyEnabled(cfg: GrantedConfig): boolean {
...
function isActiveMemoryPluginEnabled(cfg: GrantedConfig): boolean {
...
function shouldRememberAcrossConversations(cfg: GrantedConfig, agentId: string): boolean {
