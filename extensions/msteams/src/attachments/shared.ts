...
import { responseWithRelease } from "granted/plugin-sdk/fetch-runtime";
import {
  ...
  type SsrFPolicy,
} from "granted/plugin-sdk/ssrf-policy";
import { fetchWithSsrFGuard, type LookupFn } from "granted/plugin-sdk/ssrf-runtime";
import {
  isRecord,
