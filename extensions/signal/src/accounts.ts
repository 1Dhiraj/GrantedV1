...
function isSignalAccountEnabled(cfg: GrantedConfig, config: SignalAccountConfig): boolean {
...
export function listEnabledSignalAccounts(cfg: GrantedConfig): ResolvedSignalAccount[] {
