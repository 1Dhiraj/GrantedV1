...
function readPluginXaiWebSearchApiKeyResult(cfg?: GrantedConfig): ReadOnlyEnvSecretRefResolution {
...
export function resolveFallbackXaiAuth(cfg?: GrantedConfig): XaiFallbackAuth | undefined {
