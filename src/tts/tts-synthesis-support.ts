import { normalizeOptionalString as readTtsResultString } from "@granted/normalization-core/string-coerce";
import type { GrantedConfig, ResolvedTtsPersona, TtsProvider } from "../config/types.js";
