...
function resolveSpeechProviderPluginEntries(cfg?: GrantedConfig): SpeechProviderPlugin[] {
...
export function listLoadedSpeechProviders(_cfg?: GrantedConfig): SpeechProviderPlugin[] {
