...
function hasExplicitChannelConfigEntry(cfg: GrantedConfig): boolean {
...
export async function assertValidCronCreateDelivery(cfg: GrantedConfig, job: CronJobCreate) {
