...
function readDevicePairPublicUrlFromConfig(cfg: GrantedConfig): string | undefined {
...
async function resolveLocalGatewayPasswordSecretIfNeeded(cfg: GrantedConfig): Promise<void> {
