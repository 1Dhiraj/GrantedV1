...
export function resolveImageFallbackDefaultProvider(cfg: GrantedConfig | undefined): string {
...
function resolveFallbackCandidateModelProviderCacheParts(cfg: GrantedConfig | undefined): unknown {
