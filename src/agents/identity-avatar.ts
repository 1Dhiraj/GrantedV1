...
function resolveAvatarSource(cfg: GrantedConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: GrantedConfig, agentId: string): AgentAvatarResolution {
