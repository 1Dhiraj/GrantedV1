...
export function coerceImageModelConfig(cfg?: GrantedConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: GrantedConfig; ref: string }): string[] {
