...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "@granted/plugin-sdk/agent-core": bundledAgentCore,
  "openclaw/plugin-sdk/llm": bundledLlm,
  "@granted/plugin-sdk/llm": bundledLlm,
  "openclaw/plugin-sdk/agent-sessions": bundledAgentSessions,
  "@granted/plugin-sdk/agent-sessions": bundledAgentSessions,
};
...
function getExtensionLoaderAliases(): Record<string, string> {
  ...
  aliases = {
    ...
    "@granted/plugin-sdk/agent-sessions": agentSessionsEntry,
