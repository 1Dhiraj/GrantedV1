...
import type { AgentTool, AgentToolResult } from "granted/plugin-sdk/agent-core";
...
import * as openClawPluginTools from "./granted-plugin-tools.js";
...
describe("createOpenClawCodingTools", () => {
  ...
  it("records core tool-prep stages for hot-path diagnostics", () => {
    ...
    expect(stages.indexOf("granted-tools:test-helper")).toBeLessThan(
      stages.indexOf("granted-tools"),
    );
