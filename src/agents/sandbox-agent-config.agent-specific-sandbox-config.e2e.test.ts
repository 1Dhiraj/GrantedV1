...
async function resolveContext(config: GrantedConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): GrantedConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
