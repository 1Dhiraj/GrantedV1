...
export function prepareCliProviderClassifier(cfg?: GrantedConfig): CliProviderClassifier {
...
export function isCliProvider(provider: string, cfg?: GrantedConfig): boolean {
