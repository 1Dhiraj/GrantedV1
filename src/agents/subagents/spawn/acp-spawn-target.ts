...
function isExplicitlyAllowedAcpAgent(cfg: GrantedConfig, agentId: string): boolean {
...
export function resolveConfiguredAcpSubagentTargetIds(cfg: GrantedConfig): string[] {
