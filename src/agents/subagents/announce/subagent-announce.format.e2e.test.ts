...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    previousFastTestEnv = process.env.GRANTED_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.GRANTED_TEST_FAST = previousFastTestEnv;
  });
  ...
  beforeEach(() => {
    vi.useRealTimers();
    // GRANTED_TEST_FAST is set in beforeAll before module import
