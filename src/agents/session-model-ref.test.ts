...
function modelConfig(primary: string, models?: Record<string, object>): GrantedConfig {
  return {
    agents: {
...
describe("resolveSessionModelIdentityRef", () => {
  const resolveLegacyIdentityRef = (cfg: GrantedConfig, modelProvider?: string) =>
  ...
  test("infers provider from configured provider catalogs when allowlist is absent", () => {
    ...
    } as unknown as GrantedConfig["models"];
