...
} from "./granted-state-db-audit-migration.js";
import {
  GRANTED_STATE_STRICT_SCHEMA_VERSION,
  type GrantedStateDatabaseOptions,
  type GrantedStateDatabaseSchemaMigration,
} from "./granted-state-db-contract.js";
import { resolveDatabasePath } from "./granted-state-db-maintenance.js";
import * as operatorApprovalMigration from "./granted-state-db-operator-approval-migration.js";
import {
  tableExists,
  tableHasColumn,
  tablePrimaryKeyColumns,
} from "./granted-state-db-schema-helpers.js";
import { GrantedStateDatabaseSchemaMigrationRequiredError } from "./granted-state-db-schema-migration-required.js";
import { FOLDED_SINGLETON_STATE_TABLES_V12 } from "./granted-state-db-schema-v12-foldin.js";
...
} from "./granted-state-db-table-retirements.js";
import {
