...
import { toStructuredErrorObject } from "@granted/normalization-core/error-coercion";
...
import { recordOpenClawDatabaseQuarantine } from "./granted-quarantine-store.js";
import {
...
export const GRANTED_DATABASE_VERIFY_INITIAL_DELAY_MS = 5 * 60_000;
export const GRANTED_DATABASE_VERIFY_INTERVAL_MS = 24 * 60 * 60_000;

const log = createSubsystemLogger("state/database-verify");
const DATABASE_VERIFY_CHILD_ARG = "--granted-database-verify-child";
