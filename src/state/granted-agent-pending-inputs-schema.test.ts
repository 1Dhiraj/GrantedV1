...
import { ensureSessionPendingInputsSchema } from "./granted-agent-pending-inputs-schema.js";
import { GRANTED_AGENT_SCHEMA_SQL } from "./granted-agent-schema.js";
import { tableHasColumn, tableExists } from "./granted-state-db-schema-helpers.js";
