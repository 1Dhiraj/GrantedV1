...
vi.mock("./granted-state-schema.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./granted-state-schema.js")>();
  return {
    ...actual,
...
import { ensureSecretStoreSchema } from "./granted-state-db-schema-additive.js";
