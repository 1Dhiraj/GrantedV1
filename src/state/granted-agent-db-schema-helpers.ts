...
} from "./granted-agent-board-schema.js";
import { CONTEXT_ENGINE_TURN_OUTBOX_TABLE } from "./granted-agent-context-engine-turn-outbox-schema.js";
import { FIRST_USE_ADDITIVE_AGENT_COLUMN_DEFINITIONS } from "./granted-agent-db-additive-columns.js";
import {
  AGENT_MEDIA_SCHEMA_VERSION,
  GRANTED_AGENT_SCHEMA_VERSION,
} from "./granted-agent-db-contract.js";
import { GrantedAgentDatabaseMediaMigrationRequiredError } from "./granted-agent-db-migration-required.js";
import {
  ensureSessionAdditiveColumns,
  ensureSessionEntryValidityProjection,
} from "./granted-agent-db-session-migrations.js";
import { SESSION_GOAL_OPERATIONS_TABLE } from "./granted-agent-goal-operations-schema.js";
import { MESSAGE_TOOL_RUN_OUTCOMES_TABLE } from "./granted-agent-message-tool-outcome-schema.js";
import { LEGACY_PARTICIPANT_OPTIONAL_COLUMNS } from "./granted-agent-participants-migration.js";
import { SESSION_PENDING_INPUTS_TABLE } from "./granted-agent-pending-inputs-schema.js";
import {
  ensureOpenClawAgentProgressCardSchemaInTransaction,
  AGENT_PROGRESS_CARD_SCHEMA_SQL,
  SESSION_PROGRESS_CARDS_TABLE,
} from "./granted-agent-progress-card-schema.js";
import { GRANTED_AGENT_SCHEMA_SQL } from "./granted-agent-schema.js";
import { SESSION_PARTICIPANTS_TABLE } from "./granted-agent-session-participants-schema.js";
import {
  AGENT_V14_ADDITIVE_SCHEMA_SQL,
  AGENT_V14_CORE_SCHEMA_SQL,
  AGENT_V14_SESSION_SHARING_SCHEMA_SQL,
} from "./granted-agent-session-sharing-schema.js";
import { SESSION_TRANSCRIPT_ARCHIVES_TABLE } from "./granted-agent-session-transcript-archive-schema.js";
import {
  STANDING_INTENTS_FTS_SHADOW_TABLES,
  STANDING_INTENTS_FTS_TABLE,
  STANDING_INTENTS_TABLE,
} from "./granted-agent-standing-intents-schema.js";
