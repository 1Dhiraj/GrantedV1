...
>(
  ...
  options?: {
    ...
    additionalAccountIds?: (cfg: GrantedConfig) => Iterable<string>;
    fallbackAccountIdWhenEmpty?: string | false;
    implicitDefaultAccount?: {
      channelKeys?: readonly string[];
      envVars?: readonly string[];
    };
    hasImplicitDefaultAccount?: (cfg: GrantedConfig) => boolean;
    resolveImplicitAccountId?: (cfg: GrantedConfig) => string | undefined;
  },
) {
  function hasImplicitDefaultAccount(cfg: GrantedConfig): boolean {
  ...
  function resolveConfiguredDefaultAccountId(cfg: GrantedConfig): string | undefined {
    const channel = cfg.channels?.[channelKey] as Record<string, unknown> | undefined;
  ...
  function listConfiguredAccountIds(cfg: GrantedConfig): string[] {
  ...
  function listAccountIds(cfg: GrantedConfig): string[] {
  ...
  return {
    ...
    resolveAccountConfig: (cfg: GrantedConfig, accountId: string): TConfig => {
