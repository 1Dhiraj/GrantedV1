...
export type ChannelMessageSendTextContext<TConfig = GrantedConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = GrantedConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = GrantedConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = GrantedConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = GrantedConfig> =
...
type ChannelMessageSendFailureContext<TConfig = GrantedConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = GrantedConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
export type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = GrantedConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
