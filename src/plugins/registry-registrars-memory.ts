...
export function createMemoryRegistrars(state: PluginRegistryState) {
  ...
  const registerMemoryCapability = (
    record: PluginRecord,
    capability: Parameters<GrantedPluginApi["registerMemoryCapability"]>[0],
  ) => {
  ...
  const registerMemoryPromptSupplement = (
    record: PluginRecord,
    builder: Parameters<GrantedPluginApi["registerMemoryPromptSupplement"]>[0],
  ) => {
  ...
  const registerMemoryPromptPreparation = (
    record: PluginRecord,
    prepare: Parameters<GrantedPluginApi["registerMemoryPromptPreparation"]>[0],
  ) => {
  ...
  const registerMemoryCorpusSupplement = (
    record: PluginRecord,
    supplement: Parameters<GrantedPluginApi["registerMemoryCorpusSupplement"]>[0],
  ) => {
