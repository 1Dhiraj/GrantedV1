...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.openclaw/plugins/vllm/granted.plugin.json",
    manifestHash: "hash",
    ...
    compat: [],
    packageName: "@granted/vllm",
    packageInstall: {
      npm: {
        spec: "@granted/vllm-fork@1.0.0",
        packageName: "@granted/vllm-fork",
        selector: "1.0.0",
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/granted.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@granted/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@granted/openai@1.2.3",
              packageName: "@granted/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
      ...
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "npm",
            spec: "@granted/vllm",
            resolvedSpec: "@granted/vllm@2.0.0",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.openclaw/plugins/demo-provider/granted.plugin.json",
          manifestHash: "hash",
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/granted.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadOpenClawProviderIndex.mockReturnValue({
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            id: "moonshot",
            package: "@granted/plugin-moonshot",
            install: {
              npmSpec: "@granted/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@granted/plugin-moonshot@1.2.3",
          packageName: "@granted/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
        ...
        moonshot: {
          ...
          plugin: {
            ...
            install: {
              ...
              npmSpec: "@granted/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@granted/plugin-moonshot@2026.5.2",
          packageName: "@granted/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/granted.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadOpenClawProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@granted/plugin-groq",
            install: {
              npmSpec: "@granted/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@granted/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:openclaw/vllm@2026.5.2",
              npmSpec: "@granted/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@granted/plugin-vllm@2026.5.2",
          packageName: "@granted/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
