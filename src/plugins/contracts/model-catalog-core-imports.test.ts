...
const LEGACY_MODEL_CATALOG_BRIDGES = new Map([
  [path.join(REPO_ROOT, "src/agents/provider-id.ts"), "@granted/model-catalog-core/provider-id"],
  [
    path.join(REPO_ROOT, "src/model-catalog/refs.ts"),
    "@granted/model-catalog-core/model-catalog-refs",
  ],
  [
    path.join(REPO_ROOT, "src/model-catalog/normalize.ts"),
    "@granted/model-catalog-core/model-catalog-normalize",
  ],
  [
    path.join(REPO_ROOT, "src/model-catalog/types.ts"),
    "@granted/model-catalog-core/model-catalog-types",
  ],
  [
    path.join(REPO_ROOT, "src/config/model-refs.ts"),
    "@granted/model-catalog-core/configured-model-refs",
  ],
  [
    path.join(REPO_ROOT, "src/shared/provider-model-id-normalization.ts"),
    "@granted/model-catalog-core/provider-model-id-normalization",
  ],
  [
