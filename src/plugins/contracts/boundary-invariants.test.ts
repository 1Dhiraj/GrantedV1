...
const BUNDLED_TYPED_HOOK_REGISTRATION_FILES = [
  ...
  "extensions/task-router/index.ts",
...
const BUNDLED_TYPED_HOOK_REGISTRATION_GUARDS = {
  ...
  "extensions/task-router/index.ts": ["before_agent_reply", "before_model_resolve"],
...
const BUNDLED_LIVE_CONFIG_HOOK_GUARDS = {
  "extensions/task-router/index.ts": ["resolveLivePluginConfigObject(", '"task-router"'],
