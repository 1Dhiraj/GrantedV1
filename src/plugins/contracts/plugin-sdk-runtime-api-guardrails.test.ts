...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [contractPluginPath({
    ...
    'export type { GrantedPluginServiceContext } from "./api.js";',
  ],
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "granted/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "granted/plugin-sdk/status-helpers";',
  ...
  [contractPluginPath({
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "granted/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema, GoogleChatConfigSchema } from "./config-api.js";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "granted/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "granted/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "granted/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "granted/plugin-sdk/runtime-group-policy";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "granted/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "granted/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "granted/plugin-sdk/webhook-request-guards";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "granted/plugin-sdk/allow-from";',
      'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "granted/plugin-sdk/channel-contract";',
      ...
      'export { createChannelMessageReplyPipeline } from "granted/plugin-sdk/channel-outbound";',
      'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "granted/plugin-sdk/channel-status";',
      'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "granted/plugin-sdk/channel-targets";',
      'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, GrantedConfig } from "granted/plugin-sdk/config-contracts";',
      'export { isDangerousNameMatchingEnabled } from "granted/plugin-sdk/dangerous-name-runtime";',
      ...
      'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension } from "granted/plugin-sdk/media-runtime";',
      'export { resolveChannelMediaMaxBytes } from "granted/plugin-sdk/account-helpers";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "granted/plugin-sdk/ssrf-runtime";',
    ...
    'export { writeJsonFileAtomically } from "granted/plugin-sdk/json-store";',
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "granted/plugin-sdk/channel-contract";',
    'export type { GrantedConfig } from "granted/plugin-sdk/config-contracts";',
    'export { formatZonedTimestamp } from "granted/plugin-sdk/time-runtime";',
    'export type { PluginRuntime, RuntimeLogger } from "granted/plugin-sdk/plugin-runtime";',
    'export type { RuntimeEnv } from "granted/plugin-sdk/runtime-env";',
  ...
  [contractPluginPath({
    ...
    'export { createChannelPairingController } from "granted/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, GrantedConfig } from "granted/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "granted/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "granted/plugin-sdk/channel-outbound";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "signal", relativePath: "runtime-api.ts" })]: [
    ...
    'export { DEFAULT_ACCOUNT_ID, applyAccountNameToChannelSection, deleteAccountFromConfigSection, emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta, migrateBaseNameToDefaultAccount, normalizeAccountId, setAccountEnabledInConfigSection } from "granted/plugin-sdk/core";',
    'export { resolveChannelMediaMaxBytes } from "granted/plugin-sdk/account-helpers";',
    ...
    'export { resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy } from "granted/plugin-sdk/runtime-group-policy";',
    'export { buildBaseAccountStatusSnapshot, buildBaseChannelStatusSummary, collectStatusIssuesFromLastError, createDefaultChannelRuntimeState } from "granted/plugin-sdk/status-helpers";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { GrantedPluginService, GrantedPluginServiceContext, PluginLogger } from "granted/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "granted/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "granted/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "granted/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "granted/plugin-sdk/channel-plugin-common";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "granted/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "granted/plugin-sdk/channel-actions";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "granted/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "granted/plugin-sdk/channel-core";',
  ...
  [contractPluginPath({
    ...
    'export type { GrantedPluginApi } from "granted/plugin-sdk/plugin-entry";',
    'export type { GatewayRequestHandlerOptions } from "granted/plugin-sdk/gateway-runtime";',
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "granted/plugin-sdk/webhook-request-guards";',
    'export { fetchWithSsrFGuard, isBlockedHostnameOrIp } from "granted/plugin-sdk/ssrf-runtime";',
    'export type { SessionEntry } from "granted/plugin-sdk/session-store-runtime";',
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "granted/plugin-sdk/tts-runtime";',
    'export { sleep } from "granted/plugin-sdk/runtime-env";',
  ],
