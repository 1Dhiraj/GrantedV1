...
import { resolveUnsupportedToolSchemaKeywords } from "@granted/ai/internal/openai";
import { resolveOpenAICompletionsCompat } from "@granted/ai/transports";
...
// Tool-schema compat predicates moved into @granted/ai (agent-tools-parameter-schema);
