...
export const DEPRECATION_MARKING_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "@granted/discord buildDiscordInteractiveComponents",
      "@granted/slack buildSlackInteractiveBlocks",
      "@granted/telegram buildTelegramInteractiveButtons",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    surfaces: [
      "@granted/google-meet __testing",
      "@granted/discord buildDiscordInteractiveComponents",
      "@granted/discord normalizeDiscordListenerTimeoutMs",
      "@granted/discord normalizeDiscordInboundWorkerTimeoutMs",
      "@granted/discord isAbortError",
      "@granted/discord runDiscordTaskWithTimeout",
      "@granted/slack buildSlackInteractiveBlocks",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "@granted/memory-host-sdk ensureMemoryIndexSchema.embeddingCacheTable",
      "@granted/memory-host-sdk ensureMemoryIndexSchema.ftsTable",
      "@granted/memory-host-sdk/runtime-core loadConfig",
      "@granted/memory-host-sdk/host/openclaw-runtime loadConfig",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "GrantedPluginApi.registerSessionExtension",
      "GrantedPluginApi.enqueueNextTurnInjection",
      "GrantedPluginApi.registerControlUiDescriptor",
      "GrantedPluginApi.registerRuntimeLifecycle",
      "GrantedPluginApi.registerAgentEventSubscription",
      "GrantedPluginApi.emitAgentEvent",
      "GrantedPluginApi.setRunContext",
      "GrantedPluginApi.getRunContext",
      "GrantedPluginApi.clearRunContext",
      "GrantedPluginApi.registerSessionSchedulerJob",
      "GrantedPluginApi.registerSessionAction",
      "GrantedPluginApi.sendSessionAttachment",
      "GrantedPluginApi.scheduleSessionTurn",
      "GrantedPluginApi.unscheduleSessionTurnsByTag",
