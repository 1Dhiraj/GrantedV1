...
export type MemoryPluginRuntime = {
  ...
  closeMemorySearchManager?(params: { cfg: GrantedConfig; agentId: string }): Promise<void>;
...
export type MemoryPluginPublicArtifactsProvider = {
  listArtifacts(params: { cfg: GrantedConfig }): Promise<MemoryPluginPublicArtifact[]>;
};
