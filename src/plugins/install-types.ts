...
export const PLUGIN_INSTALL_ERROR_CODE = {
  ...
  MISSING_GRANTED_EXTENSIONS: "missing_openclaw_extensions",
  MISSING_PLUGIN_MANIFEST: "missing_plugin_manifest",
  EMPTY_GRANTED_EXTENSIONS: "empty_openclaw_extensions",
  INVALID_GRANTED_EXTENSIONS: "invalid_openclaw_extensions",
