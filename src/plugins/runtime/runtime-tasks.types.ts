...
export type BoundTaskRunsRuntime = {
  ...
  cancel: (params: { taskId: string; cfg: GrantedConfig }) => Promise<TaskRunCancelResult>;
};
...
export type PluginRuntimeTaskRuns = {
  ...
  fromToolContext: (
    ctx: Pick<GrantedPluginToolContext, "sessionKey" | "agentId" | "deliveryContext">,
  ) => BoundTaskRunsRuntime;
};
...
export type PluginRuntimeTaskFlows = {
  ...
  fromToolContext: (
    ctx: Pick<GrantedPluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskFlowsRuntime;
};
