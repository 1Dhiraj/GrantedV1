...
import { asFiniteNumber, asFiniteNumberInRange } from "@granted/normalization-core";
...
function resolveRuntimeConfig(options: CreateRuntimeLlmOptions): GrantedConfig {
