...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.granted.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.granted.js").GrantedConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.granted.js").GrantedConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.granted.js").GrantedConfig>;
    /**
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("granted/plugin-sdk/llm").Model<import("granted/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.granted.js").GrantedConfig;
      workspaceDir?: string;
