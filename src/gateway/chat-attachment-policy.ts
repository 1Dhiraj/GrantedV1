...
export function resolveChatAttachmentMaxBytes(cfg: GrantedConfig): number {
 ...
 */
export function resolveChatAttachmentPolicy(cfg: GrantedConfig): ChatAttachmentPolicy {
