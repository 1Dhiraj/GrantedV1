...
export function hasActiveGatewayAuthSecretRef(config: GrantedConfig): boolean {
...
export function assertRuntimeGatewayAuthNotKnownWeak(config: GrantedConfig): void {
