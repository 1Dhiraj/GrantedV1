        ...
        await withEnvAsync(
          {
            ...
            USERPROFILE: root,
            GRANTED_HOME: root,
            GRANTED_STATE_DIR: path.join(root, "source-state"),
            GRANTED_CONFIG_PATH: path.join(root, "source-config.json"),
            GRANTED_LIVE_TEST: "1",
          ...
          async () => {
            ...
            try {
              ...
              try {
                ...
                expect(instance.env.GRANTED_HOME).toBe(process.env.GRANTED_HOME);
                ...
                expect(process.env.HOME).toBe(callerHome);
                expect(process.env.GRANTED_STATE_DIR).toBe(instance.stateDir);
              } finally {
