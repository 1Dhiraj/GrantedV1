...
export function hasAmbiguousGatewayAuthModeConfig(cfg: GrantedConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: GrantedConfig): void {
