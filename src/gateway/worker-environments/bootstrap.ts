...
const NODE_MISSING_MARKER = "GRANTED_WORKER_NODE_MISSING";
const NODE_UNSUPPORTED_MARKER = "GRANTED_WORKER_NODE_UNSUPPORTED";
const NPM_MISSING_MARKER = "GRANTED_WORKER_NPM_MISSING";
const BOOTSTRAP_OUTPUT_TAG = "GRANTED_WORKER_BOOTSTRAP_V1";
