...
async function cleanupCronTestRun(params: {
  ...
  process.env.GRANTED_SKIP_CRON = params.prevSkipCron;
}
...
async function setupCronTestRun(params: {
  ...
  const prevSkipCron = process.env.GRANTED_SKIP_CRON;
...
type DirectCronState = GatewayCronState & {
  getRuntimeConfig: () => import("../config/types.granted.js").GrantedConfig;
};
