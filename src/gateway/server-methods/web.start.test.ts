  ...
  it("surfaces the missing official external plugin hint when no web-login provider is loaded", async () => {
    ...
    mocks.resolveMissingOfficialExternalChannelPluginRepairHints.mockReturnValue([
      {
        ...
        channelId: "whatsapp",
        label: "WhatsApp",
        installSpec: "clawhub:@granted/whatsapp",
        installCommand: "openclaw plugins install clawhub:@granted/whatsapp",
        doctorFixCommand: "openclaw doctor --fix",
        repairHint:
          "Install the official external plugin with: openclaw plugins install clawhub:@granted/whatsapp, or run: openclaw doctor --fix.",
      },
    ]);
    const respond = vi.fn();
    ...
    expect(respond).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        message:
          "web login provider is not available. Install the official external plugin with: openclaw plugins install clawhub:@granted/whatsapp, or run: openclaw doctor --fix.",
      }),
    );
  ...
  it("joins multiple missing official external plugin hints when more than one configured channel is missing", async () => {
              ...
              ? [
                  {
                    ...
                    channelId: "signal",
                    label: "Signal",
                    installSpec: "clawhub:@granted/signal",
                    installCommand: "openclaw plugins install clawhub:@granted/signal",
                    doctorFixCommand: "openclaw doctor --fix",
                    repairHint:
                      "Install the official external plugin with: openclaw plugins install clawhub:@granted/signal, or run: openclaw doctor --fix.",
                  },
                ]
              : [],
        ),
    ...
    expect(respond).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        code: "INVALID_REQUEST",
        message:
          "web login provider is not available. Configured official external channel plugins are missing for WhatsApp, Signal. Install them with: openclaw plugins install clawhub:@granted/whatsapp; openclaw plugins install clawhub:@granted/signal, or run: openclaw doctor --fix.",
      }),
    );
  });
