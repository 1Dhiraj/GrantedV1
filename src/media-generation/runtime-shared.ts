...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: GrantedConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: GrantedConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: GrantedConfig;
  agentDir?: string;
  listProviders: (cfg?: GrantedConfig) => CapabilityProviderCandidate[];
}): string[] {
