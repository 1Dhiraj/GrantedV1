import { asFiniteNumber as readFiniteNumberValue } from "@granted/normalization-core/number-coercion";
import { asOptionalRecord as readRecordValue } from "@granted/normalization-core/record-coerce";
