...
export function withFullRuntimeReplyConfig<T extends GrantedConfig>(config: T): T {
...
export function resolveGetReplyConfig(params: {
  ...
  return applyMergePatch(params.getRuntimeConfig(), configOverride) as GrantedConfig;
}
