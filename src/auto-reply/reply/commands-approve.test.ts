...
const approvalPolicies = new WeakMap<GrantedConfig, ApprovalTestPolicy>();

function withApprovalPolicy(cfg: GrantedConfig, policy: ApprovalTestPolicy): GrantedConfig {
