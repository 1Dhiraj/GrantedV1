...
const emptyCfg = {} as GrantedConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as GrantedConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as GrantedConfig, "whatsapp", "default", "group")).toBe("all");
  });
