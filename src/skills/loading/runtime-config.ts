...
function hasConfiguredSkillApiKeyRef(config?: GrantedConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: GrantedConfig): GrantedConfig | undefined {
