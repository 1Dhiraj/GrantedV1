...
function collectAcpxConfigAssignments(config: GrantedConfig): ResolverContext {
  return collectAssignments(config, [["acpx", "bundled"]]);
}

function expectInactiveAcpxConfig(config: GrantedConfig): void {
