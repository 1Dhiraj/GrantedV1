...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof GrantedConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: GrantedConfig; env: NodeJS.ProcessEnv }): {
  cfg: GrantedConfig;
  changes: string[];
} {
