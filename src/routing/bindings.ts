...
export function listBindings(cfg: GrantedConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: GrantedConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: GrantedConfig) {
