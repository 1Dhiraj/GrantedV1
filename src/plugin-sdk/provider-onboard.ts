...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: GrantedConfig, ...args: TArgs) => GrantedConfig;
  applyConfig: (cfg: GrantedConfig, ...args: TArgs) => GrantedConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: GrantedConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: GrantedConfig, preset: TParams) => GrantedConfig;
  primaryModelRef: string;
...
export function createAliasOnlyPresetAppliers(params: {
  ...
  const applyProviderConfig = (cfg: GrantedConfig): GrantedConfig => {
...
export function applyAgentDefaultModelPrimary(cfg: GrantedConfig, primary: string): GrantedConfig {
...
export function applyOpencodeZenModelDefault(cfg: GrantedConfig): {
  next: GrantedConfig;
  changed: boolean;
} {
