...
export function openAiPluginPersonalityConfig(personality: "friendly" | "off"): GrantedConfig {
  return {
    plugins: {
      entries: {
        openai: {
...
export function sharedGpt5PersonalityConfig(_personality: "friendly" | "off"): GrantedConfig {
  return {};
}
