...
type ApproverRestrictedNativeApprovalFlatParams = {
  ...
  isNativeDeliveryEnabled: (params: { cfg: GrantedConfig; accountId?: string | null }) => boolean;
...
type StandardNativeApprovalRoutingParams = {
  ...
  isTransportEnabled: (params: { cfg: GrantedConfig; accountId?: string | null }) => boolean;
  /** Lists channel account ids for route and DM availability checks. */
  listAccountIds: (cfg: GrantedConfig) => readonly string[];
  /** Resolves the channel's default account id. */
  resolveDefaultAccountId: (cfg: GrantedConfig) => string;
...
function buildApproverRestrictedNativeApprovalCapability(
  ...
  return createChannelApprovalCapability({
    ...
    delivery: {
      hasConfiguredDmRoute: ({ cfg }: { cfg: GrantedConfig }) =>
