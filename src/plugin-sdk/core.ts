...
import type { GrantedPluginApi } from "../plugins/types.js";
...
export { parseStrictPositiveInteger } from "@granted/normalization-core/number-coercion";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: GrantedConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
