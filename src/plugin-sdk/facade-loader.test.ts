...
describe("plugin-sdk facade loader", () => {
  it("resolves channel config facades lazily from generated plugin fixtures", async () => {
    process.env.GRANTED_BUNDLED_PLUGINS_DIR = createBundledChannelConfigFixtures();
  ...
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    ...
    process.env.GRANTED_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.GRANTED_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    ...
    process.env.GRANTED_BUNDLED_PLUGINS_DIR = createTempDirSync("openclaw-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    ...
    process.env.GRANTED_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
