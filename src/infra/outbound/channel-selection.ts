...
export function isConfiguredChannel(cfg: GrantedConfig, channelId: string): boolean {
...
export async function listConfiguredMessageChannels(cfg: GrantedConfig): Promise<string[]> {
