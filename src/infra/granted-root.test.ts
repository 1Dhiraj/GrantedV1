...
const FIXTURE_BASE = path.join(VITEST_FS_BASE, "granted-root");
...
function expectResolvedPackageRoot(
  syncResolver: typeof import("./granted-root.js").resolveOpenClawPackageRootSync,
  asyncResolver: typeof import("./granted-root.js").resolveOpenClawPackageRoot,
  opts: Parameters<typeof import("./granted-root.js").resolveOpenClawPackageRootSync>[0],
...
vi.mock("./granted-root.fs.runtime.js", () => ({
...
describe("resolveOpenClawPackageRoot", () => {
  ...
  let resolveOpenClawPackageRootSync: typeof import("./granted-root.js").resolveOpenClawPackageRootSync;

  beforeAll(async () => {
    ({ resolveOpenClawPackageRoot, resolveOpenClawPackageRootSync } =
      await import("./granted-root.js"));
  });
