...
const UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART_ENV = "GRANTED_UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART";
...
const UPDATE_DOCTOR_SERVICE_REPAIR_POLICY_ENV = "GRANTED_SERVICE_REPAIR_POLICY";
