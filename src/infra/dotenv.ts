...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "OPENAI_API_KEYS",
  "GRANTED_AGENT_DIR",
  "GRANTED_ALLOW_PLUGIN_INSTALL_OVERRIDES",
  "GRANTED_ALLOW_INSECURE_PRIVATE_WS",
  "GRANTED_ALLOW_PROJECT_LOCAL_BIN",
  "GRANTED_BROWSER_EXECUTABLE_PATH",
  "GRANTED_BROWSER_CONTROL_MODULE",
  "GRANTED_BUNDLED_HOOKS_DIR",
  "GRANTED_BUNDLED_PLUGINS_DIR",
  "GRANTED_BUNDLED_SKILLS_DIR",
  "GRANTED_CACHE_TRACE",
  ...
  "GRANTED_MPM_CATALOG_PATHS",
  "GRANTED_NODE_EXEC_FALLBACK",
  "GRANTED_NODE_EXEC_HOST",
  "GRANTED_OAUTH_DIR",
  "GRANTED_PINNED_PYTHON",
  "GRANTED_PINNED_WRITE_PYTHON",
  "GRANTED_PLUGIN_INSTALL_OVERRIDES",
  "GRANTED_PLUGIN_CATALOG_PATHS",
  "GRANTED_PROFILE",
  "GRANTED_RAW_STREAM",
  "GRANTED_RAW_STREAM_PATH",
  "GRANTED_SHOW_SECRETS",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.openclaw/.env (or GRANTED_STATE_DIR/.env),
