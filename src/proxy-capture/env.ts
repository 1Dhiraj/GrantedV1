...
const GRANTED_DEBUG_PROXY_ENABLED = "GRANTED_DEBUG_PROXY_ENABLED";
const GRANTED_DEBUG_PROXY_URL = "GRANTED_DEBUG_PROXY_URL";
const GRANTED_DEBUG_PROXY_CERT_DIR = "GRANTED_DEBUG_PROXY_CERT_DIR";
const GRANTED_DEBUG_PROXY_SESSION_ID = "GRANTED_DEBUG_PROXY_SESSION_ID";
const GRANTED_DEBUG_PROXY_REQUIRE = "GRANTED_DEBUG_PROXY_REQUIRE";
...
export function resolveDebugProxySettings(
  ...
  const enabled = isTruthy(env[GRANTED_DEBUG_PROXY_ENABLED]);
  const explicitSessionId = env[GRANTED_DEBUG_PROXY_SESSION_ID]?.trim() || undefined;
  ...
  return {
    enabled,
    required: isTruthy(env[GRANTED_DEBUG_PROXY_REQUIRE]),
    proxyUrl: env[GRANTED_DEBUG_PROXY_URL]?.trim() || undefined,
    dbPath: resolveDebugProxyDbPath(env),
    blobDir: resolveDebugProxyBlobDir(env),
    certDir: env[GRANTED_DEBUG_PROXY_CERT_DIR]?.trim() || resolveDebugProxyCertDir(env),
    sessionId,
...
export function applyDebugProxyEnv(
  ...
  return {
    ...
    [GRANTED_DEBUG_PROXY_REQUIRE]: "1",
    [GRANTED_DEBUG_PROXY_URL]: params.proxyUrl,
    [GRANTED_DEBUG_PROXY_CERT_DIR]: params.certDir ?? resolveDebugProxyCertDir(env),
    [GRANTED_DEBUG_PROXY_SESSION_ID]: params.sessionId,
