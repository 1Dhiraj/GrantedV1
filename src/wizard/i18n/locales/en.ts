...
export const en = {
  ...
  wizard: {
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: GRANTED_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var GRANTED_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: GRANTED_TWITCH_ACCESS_TOKEN",
    ...
    finalize: {
      ...
      gatewayTokenStored:
        "Stored in: $GRANTED_CONFIG_PATH (default: ~/.openclaw/openclaw.json) under gateway.auth.token, or in GRANTED_GATEWAY_TOKEN.",
