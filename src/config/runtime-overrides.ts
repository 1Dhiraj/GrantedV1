...
function applyOverrideTree(cfg: GrantedConfig, overrideTree: OverrideTree): GrantedConfig {
  const next = mergeOverrides(cfg, overrideTree) as GrantedConfig;
...
export function applyConfigOverrides(cfg: GrantedConfig): GrantedConfig {
...
export function captureConfigOverrideApplier(): (cfg: GrantedConfig) => GrantedConfig {
