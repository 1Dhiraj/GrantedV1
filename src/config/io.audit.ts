...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.GRANTED_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.GRANTED_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.GRANTED_WATCH_COMMAND),
