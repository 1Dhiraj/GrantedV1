...
function codexPluginEntryEnabled(cfg: GrantedConfig): boolean | undefined {
...
function resolveEffectiveSelectedModelRefs(params: { cfg: GrantedConfig; agentId: string }): {
  complete: boolean;
