...
async function persistRiskAcknowledgement(config: GrantedConfig): Promise<string | undefined> {
...
}): Promise<{ quickstart: boolean; config: GrantedConfig; securityAcknowledgedAt: string }> {
