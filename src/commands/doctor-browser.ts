...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: GrantedConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: GrantedConfig, deps?: BrowserDoctorDeps) {
  try {
