...
function hasConfiguredCodexOAuthProfile(cfg: GrantedConfig): boolean {
...
export function noteLegacyCodexProviderOverride(cfg: GrantedConfig): void {
...
function listAuthProfileHealthTargets(cfg: GrantedConfig): AuthProfileHealthTarget[] {
