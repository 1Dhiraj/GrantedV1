...
function resolveEffectiveTrustConfig(cfg: GrantedConfig, env?: NodeJS.ProcessEnv): GrantedConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: GrantedConfig): string[] | undefined {
