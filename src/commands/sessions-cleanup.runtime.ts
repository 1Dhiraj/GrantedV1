...
function prepareCleanupHarnessOwners(config: GrantedConfig, workspaceDir: string) {
...
export async function runLocalSessionsCleanup(
  params: { cfg: GrantedConfig; opts: SessionsCleanupOptions; targets: SessionStoreTarget[] },
  runtime: RuntimeEnv,
