...
export function scanLegacyToolsBySenderKeys(cfg: GrantedConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: GrantedConfig): {
