...
export function collectMissingDefaultAccountBindingWarnings(cfg: GrantedConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: GrantedConfig): string[] {
  const warnings: string[] = [];
