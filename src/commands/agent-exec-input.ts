 ...
 */
function stripInheritedAgentLocations(base: GrantedConfig): GrantedConfig {
 ...
 */
function buildExecConfigDefaults(): GrantedConfig {
  return {
...
export function buildExecRunConfig(params: {
  ...
  ) as GrantedConfig; // SAFETY: Merging three typed configs preserves the GrantedConfig shape.
}
