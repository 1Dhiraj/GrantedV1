...
function hasExplicitMemorySearchConfig(cfg: GrantedConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: GrantedConfig): MemoryPluginStatus {
