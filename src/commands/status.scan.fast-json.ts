...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: GrantedConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: GrantedConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: GrantedConfig): boolean {
